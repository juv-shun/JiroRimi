...
| 1.3.6 | 初回登録モード | マイページに初回ユーザー向けモードを実装し、必須項目入力完了まで離脱不可にする | 初回ログイン時はサイドメニューが非活性化され、プロフィール完了まで他画面へ遷移できない | 🔵 Not Started |
...
| 1.2 ユーザー認証 | 6 | 6 | 0 | 0 |
| 1.3 プロフィール設定 | 6 | 5 | 0 | 1 |
| 1.4 大会作成・管理 | 8 | 0 | 0 | 8 |
| 1.5 大会エントリー | 8 | 0 | 0 | 8 |
| 1.6 エントリー一覧・公開 | 4 | 0 | 0 | 4 |
| **Phase 1 合計** | **39** | **18** | **0** | **21** |
