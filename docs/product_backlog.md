...
|----|-------------------|------|-------------|-----------|
| 1.1.1 | Supabaseプロジェクト初期設定 | Supabase プロジェクトを作成し、Auth/Database/Storage/Edge Functionsを有効化 | ダッシュボードでプロジェクトが作成されている | 🔵 Not Started |
...
| ID | バックログアイテム | 説明 | 受け入れ条件 | ステータス |
|----|-------------------|------|-------------|-----------|
| 1.2.1 | X（Twitter）OAuth 設定 | Supabase Auth に X プロバイダーを設定 | Twitter Developer Portal と連携完了 | 🔵 Not Started |
...
| 1.2.5 | ユーザー情報の自動保存 | 初回ログイン時に X ID を `users` テーブルに保存 | ログイン後、users テーブルにレコードが作成される | 🔵 Not Started |
