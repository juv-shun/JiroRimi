...
| 2.2.2 | 管理者チェックイン管理機能 | 運営者がチェックインの追加・削除を行える | ・管理画面でエントリー者一覧とチェックイン状況が表示される<br>・運営者が任意の参加者のチェックインを追加できる（遅刻者対応）<br>・運営者が任意の参加者のチェックインを削除できる（ドタキャン対応）<br>・チェックイン可能時間帯外でも操作可能 | ⚪ Backlog |
| 2.2.3 | チェックイン状況一覧（公開） | チェックイン状況を誰でも閲覧できる | ・エントリープレイヤー一覧でチェックイン済み/未済が表示される<br>・チェックイン人数が表示される（例: 15/20人）<br>・未ログインユーザーも閲覧可能 | ⚪ Backlog |
