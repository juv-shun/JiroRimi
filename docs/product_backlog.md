...
| 1.5.3 | エントリー機能 | 各予選に個別でエントリーできる | ・エントリーボタンでエントリー完了<br>・期限後はボタンが非活性<br>・招待制イベントはエントリー不可 | 🔵 Not Started |
| 1.5.4 | エントリーキャンセル機能 | エントリー済みの予選をキャンセルできる | キャンセル後、再エントリー可能 | 🔵 Not Started |
| 1.5.5 | エントリープレイヤー一覧画面 | 予選ごとのエントリー者一覧を表示 | ・プレイヤー名・ロールが表示される<br>・未ログインでも閲覧可能<br>・エントリー人数を表示<br>・ロール分布を可視化 | 🔵 Not Started |
