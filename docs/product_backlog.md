...
| 2.2.4 | イベント開始機能（運営者） | 運営者が「イベント開始」操作で参加メンバーを確定しイベントを開始する | ・イベントのステータスが scheduled → in_progress に変わる<br>・チェックイン締切前でも運営者の判断で開始可能<br>・イベント開始後にチーム編成（Epic 2.3）が可能になる | ⚪ Backlog |
