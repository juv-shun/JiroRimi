...
| 7 | SCR-008-F07 | イベントステータス表示 | イベントのステータスに応じたボタン/バッジを表示 | 2.2.4 |
| 8 | SCR-008-F08 | イベント開始 | 参加者選定モーダルを表示し、除外者を選択してイベントを開始 | 2.2.4 |
| 9 | SCR-008-F09 | 開始後操作無効化 | イベント開始後はチェックイン追加・取り消しボタンを非表示 | 2.2.4 |
...
| イベントステータス | 表示 |
|-------------------|------|
| scheduled | 「イベントを開始する」ボタン（チェックイン済み10人未満の場合は非活性） |
