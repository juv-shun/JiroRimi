...
export const profileSchema = z
  .object({
    ...
    x_id: z
      ...
      .regex(/^[A-Za-z0-9_]+$/, "X IDは英数字とアンダースコアのみ使用できます")
      .refine(
  ...
  .refine((data) => data.first_role !== data.second_role, {
    message: "第2希望は第1希望と異なるロールを選択してください",
    path: ["second_role"],
  })
  .refine((data) => data.first_role !== data.third_role, {
    message: "第3希望は第1希望と異なるロールを選択してください",
    path: ["third_role"],
  })
  .refine((data) => data.second_role !== data.third_role, {
